...
var _imgFinderJs = require("./imgFinder.js");
var _imgFinderJsDefault = parcelHelpers.interopDefault(_imgFinderJs);
...
const imageFinder = new (0, _imgFinderJsDefault.default)();
...
function onScrollLoad() {
    ...
    if (clientHeight + scrollTop >= scrollHeight) toGetImages();
}
function toGetImages() {
    imageFinder.fetchImg().then(({ total , totalHits , hits  })=>{
        if (hits.length === 0 && totalHits === 0 && total === 0) (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
        else {
            insertMarkup(hits);
            if (imageFinder.page === 1) {
                ...
                (0, _notiflixDefault.default).Notify.success(`Horray! We found ${totalHits} images`);
            } else {
...
},{"./css/styles.css":"1CY4s","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","simplelightbox":"9ydBq","./imgFinder.js":"jWBBl","notiflix":"5WWYd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"kaxSc":[function() {},{}],"9ydBq":[function(require,module,exports) {
/*!
...
},{}],"jWBBl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class ImageFinder {
    ...
    async fetchImg() {
        ...
        try {
            const res = await (0, _axiosDefault.default).get(`${BASE_URL}/?key=${API_KEY}&q=${this.searchQuery}&image_type=photo&orientation=horizontal&safesearch=true&page=${this.page}&per_page=40`);
            return res.data;
        } catch (error) {
